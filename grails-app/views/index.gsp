                ...
                <div class="card">
                    ...
                    <ul class="list-group list-group-fit mb-0" style="z-index: initial;">
                        ...
                        <li class="list-group-item" style="z-index: initial;">
                            <div class="d-flex align-items-center">
                                <a href="student-take-course.html" class="avatar avatar-4by3 avatar-sm mr-3">
                                    <img src="assets/gulp.png" alt="course" class="avatar-img rounded">
                                </a>
                                <div class="flex">
                        ...
                        <li class="list-group-item" style="z-index: initial;">
                            <div class="d-flex align-items-center">
                                <a href="student-take-course.html" class="avatar avatar-4by3 avatar-sm mr-3">
                                    <img src="assets/vuejs.png" alt="course" class="avatar-img rounded">
                                </a>
                                <div class="flex">
                        ...
                        <li class="list-group-item" style="z-index: initial;">
                            <div class="d-flex align-items-center">
                                <a href="student-take-course.html" class="avatar avatar-4by3 avatar-sm mr-3">
                                    <img src="assets/nodejs.png" alt="course" class="avatar-img rounded">
                                </a>
                                <div class="flex">
                                ...
                                <div class="media-left">
                                    <div class="forum-icon-wrapper">
                                        ...
                                        <a href="student-profile.html" class="forum-thread-user">
                                            <img src="assets/people/50/guy-1.jpg" alt="" width="20" class="rounded-circle">
                                        </a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media align-items-center">
                                <div class="media-left">
                                    <div class="forum-icon-wrapper">
                                        ...
                                        <a href="student-profile.html" class="forum-thread-user">
                                            <img src="assets/people/50/guy-2.jpg" alt="" width="20" class="rounded-circle">
                                        </a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media align-items-center">
                                <div class="media-left">
                                    <div class="forum-icon-wrapper">
                                        ...
                                        <a href="student-profile.html" class="forum-thread-user">
                                            <img src="assets/people/50/woman-1.jpg" alt="" width="20" class="rounded-circle">
                                        </a>
                                    </div>
                                </div>
                                <div class="media-body">
...
<!-- Mirrored from learnplus-bootstrap.frontendmatter.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Nov 2020 17:17:31 GMT -->
</html>